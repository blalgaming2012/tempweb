# Tempweb - نظام إدارة الخدمات والعمال

## نظرة عامة
Tempweb هو نظام ويب متكامل وتفاعلي لإدارة خدمة العملاء والعمال، مبني على تقنيات حديثة مع تركيز على تجربة المستخدم الأنيقة والأمان العالي.
...
### 6. التصميم والواجهة
- تصميم عصري وأنيق مع تأثيرات تفاعلية
...
- رسوم متحركة عند تحميل الصفحات
- أيقونة Tempweb الرسمية الجديدة

## كيفية الاستخدام

### الوصول إلى النظام
1. **الصفحة الرئيسية**: افتح التطبيق لعرض الصفحة الرئيسية التي تعرض مميزات النظام
2. **تسجيل الدخول**: اضغط على زر "تسجيل الدخول" في الصفحة الرئيسية أو في الهيدر
3. **استخدام حساب تجريبي**: اختر أحد الحسابات التجريبية أدناه
4. **الوصول للوحة التحكم**: بعد تسجيل الدخول، سيتم توجيهك تلقائياً إلى لوحة التحكم

### تدفق التطبيق
- **الصفحة الرئيسية (/)**: متاحة للجميع، تعرض معلومات عن النظام
- **تسجيل الدخول (/login)**: صفحة تسجيل الدخول
- **لوحة التحكم (/dashboard)**: محمية، تتطلب تسجيل دخول
- **الصفحات الأخرى**: محمية حسب الصلاحيات
